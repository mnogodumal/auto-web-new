export default function LandingPriceCard({ tarif, price, ad, sign, month }) {
  return (
    <>
      <div className="w-[289px] h-[368px] hover:bg-[#1b1b1e] bg-[#141416] flex flex-col items-center p-[10px] rounded-[8px] cursor-pointer group">
        ...
        <div className="mt-[40px]">
          <svg className="rounded-[999px] border-solid border-[2px] border-[var(--accent---main-green)] group-hover:border-none group-hover:bg-[var(--accent---main-green)]" width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
