    ...
    <>
      <div className="w-[1216px] p-[8px] bg-[var(--general---white)] rounded-[8px] flex justify-between ">
        <div className="flex gap-[8px] items-center ml-[24px] ">
          ...
          <input className=" font-[300] text-[14px] leading-[171%] text-[var(--text---secondary)] " type="text" placeholder="Поиск по объявлениях" />
          {/* <p className=" font-[200] text-[14px] leading-[171%] text-[var(--text---secondary)] ">Поиск по объявлениях</p> */}
        </div>
        <div>
          <Button className={'font-[500] text-[14px] leading-[171%] uppercase flex items-center gap-[12px] text-[#28ad88] greenproz'} icon={<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
